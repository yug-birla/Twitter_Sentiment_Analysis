...
> **Note:** Random Forest and XGBoost were excluded from the Word2Vec evaluation due to performance and efficiency considerations with dense embeddings.
...
The best-performing configuration is **Logistic Regression with TF-IDF**, saved to `Models/logistic_tfidf.pkl`. Visualization of results is available at `Results/model_comparison.png`.
